...
var demoFrameMustache = require("./demo_frame.mustache!");

require("can/observe/");
require("./prettify");

module.exports = function(Control, demoFrameMustache, $) {
  return can.Control.extend({
    init: function() {
      ...
      this.element.html(
        demoFrameMustache({
          demoSrc: (
            (docConfig.demoSrcRoot || "..") + "/" + this.element.data("demoSrc")
          )
        })
      );
